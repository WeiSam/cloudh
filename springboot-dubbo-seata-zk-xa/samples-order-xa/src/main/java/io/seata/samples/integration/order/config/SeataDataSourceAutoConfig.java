...
public class SeataDataSourceAutoConfig {
    ...
    @Bean
    public PlatformTransactionManager txManager(@Autowired @Qualifier("dataSourceProxy") DataSource dataSourceProxy) {
     ...
     */
    @Bean
    public SqlSessionFactory sqlSessionFactory(@Autowired @Qualifier("dataSourceProxy") DataSource dataSourceProxy) throws Exception {
