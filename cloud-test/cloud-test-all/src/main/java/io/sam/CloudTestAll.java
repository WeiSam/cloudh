...
@Import(CloudTestAll.class)
public class CloudTestAll implements ApplicationRunner, CommandLineRunner, DisposableBean {

    public static void main(String[] args) {
        SpringApplication.run(CloudTestAll.class,args);
