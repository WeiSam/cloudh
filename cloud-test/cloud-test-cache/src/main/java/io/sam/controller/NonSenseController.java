...
public class NonSenseController {
    ...
    @PostMapping("/registerNonsense/{staffMagicId}")
    public BaseResponse<String> registerNonsenseByCenter(@PathVariable String staffMagicId, @RequestBody List<String> magicIds){
        log.info("staffMagicId = {},magicIds = {}",staffMagicId, JSON.toJSON(magicIds));
